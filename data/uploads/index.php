...
<body class="js">
    ...
    $stmt = $conn->prepare("SELECT * FROM product,subcategorie WHERE product.subcategorieid = subcategorie.subcategorieid and type = '1900'");
    $stmt->execute();
    $products = $stmt->fetchAll();
    foreach($products as $product){
    echo '<section class="hero-slider">';
     
    echo    '<div class="single-slider"> <div class="container"><div class="row no-gutters"><div class="col-lg-9 offset-lg-3 col-12">';
        
    echo '<div class="text-inner"><div class="row"><div class="col-lg-7 col-12"><div class="hero-text">';
                                                         
    echo '<h1><span>UP TO '. $product['discount'] .'% OFF </span>'.$product["subname"].'</h1>';
    echo '<p>Maboriosam in a nesciung eget magnae <br> dapibus disting tloctio in the find
        it pereri <br> odiy maboriosm.</p><div class="button"> 
          <a href="#" class="btn">Shop Now!</a>';
    
    echo '</div></div></div></div></div></div></div></div></div></section>';
    }                             
