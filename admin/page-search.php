...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>pages/search.css">
    <!-- END: Page CSS-->
                                        ...
                                        <ul class="media-list p-0">
                                            ...
                                            <li class="media">
                                                <div class="media-body">
                                                    <h3 class="mb-0 text-bold-400"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Modern Admin - Clean Bootstrap 4 Dashboard HTML Template</a></h3>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4 col-sm-6 col-12 pl-0">
                                                                <div class="content-group">
                                                                    <div class="media-body">
                                                                        <p class="mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Dashboard</a></p>
                                                            ...
                                                            <div class="col-lg-4 col-sm-6 col-12 pl-0">
                                                                <div class="content-group">
                                                                    <div class="media-body">
                                                                        <p class="mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Support</a></p>
                                                            ...
                                                            <div class="col-lg-4 col-sm-6 col-12 pl-0">
                                                                <div class="content-group">
                                                                    <div class="media-body">
                                                                        <p class="mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">UI Components</a></p>
                                                            ...
                                                            <div class="col-lg-4 col-sm-6 col-12 pl-0">
                                                                <div class="content-group">
                                                                    <div class="media-body">
                                                                        <p class="mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Charts</a></p>
                                                            ...
                                                            <div class="col-lg-4 col-sm-6 col-12 pl-0">
                                                                <div class="content-group">
                                                                    <div class="media-body">
                                                                        <p class="mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Form Elements</a></p>
                                                            ...
                                                            <div class="col-lg-4 col-sm-6 col-12 pl-0">
                                                                <div class="content-group">
                                                                    <div class="media-body">
                                                                        <p class="mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Documentation</a></p>
                                            ...
                                            <li class="media d-sm-flex d-block">
                                                <div class="media-left pr-sm-2 pr-0">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo $images ?>pages/search-result.jpg" alt="Generic placeholder image">
                                                    </a>
                                                </div>
                                                <div class="media-body pr-sm-50 pr-0">
                                                    <h3 class="text-bold-400 mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Attire bench - Quick win shoot me an email</a></h3>
                                                    <p class="mb-0"><a href="http://www.abdosoltan.me" class="success" target="_blank">http://www.abdosoltan.me</a></p>
                                                    <ul class="list-inline list-inline-pipe">
                                                        <li>
                                                            <i class="fa fa-star warning darken-2"></i>
                                            ...
                                            <li class="media d-sm-flex d-block">
                                                ...
                                                <div class="media-body pl-sm-50 pl-0">
                                                    <h3 class="text-bold-400 mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">The Table - for what do you feel you would</a></h3>
                                                    <p class="mb-0"><a href="http://www.abdosoltan.me" class="success" target="_blank">http://www.abdosoltan.me</a></p>
                                                    <ul class="list-inline list-inline-pipe">
                                                        <li>1M Views</li>
                                            ...
                                            <li class="media">
                                                <div class="media-body">
                                                    <h3 class="text-bold-400 mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Microdosing - deep v actually schlitz chia</a></h3>
                                                    <p class="mb-0"><a href="http://www.abdosoltan.me" class="success" target="_blank">http://www.abdosoltan.me</a></p>
                                            ...
                                            <li class="media">
                                                <div class="media-body">
                                                    <h3 class="text-bold-400 mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">Aesthetic neutra freegan, mlkshk literally</a></h3>
                                                    <p class="mb-0"><a href="http://www.abdosoltan.me" class="success" target="_blank">http://www.abdosoltan.me</a></p>
                                            ...
                                            <li class="media">
                                                <div class="media-body">
                                                    <h3 class="text-bold-400 mb-0"><a href="https://Error 404.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/search-website.php" target="_blank">iCell - disrupt butcher pitchfork.</a></h3>
                                                    <p class="mb-0"><a href="http://www.abdosoltan.me" class="success" target="_blank">http://www.abdosoltan.me</a></p>
                            ...
                            <div class="card bg-transparent border-light shadow-none">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid rounded" src="<?php echo $images ?>pages/modern.jpg" alt="logo">
                                    </div>
                                    ...
                                    <div class="knowledge-panel-suggestion">
                                        <div class="suggestion-1 d-inline-block text-center mr-2">
                                            <a href="https://1.envato.market/apex_admin" target="_blank">
                                                <img src="<?php echo $images ?>pages/1-apex.png" alt="Image description" height="40" width="40">
                                                <span class="font-small-2 d-block">Apex</span>
                                            </a>
                                        </div>
                                        <div class="suggestion-1 d-inline-block text-center mr-2">
                                            <a href="https://1.envato.market/convex_angular_admin" target="_blank">
                                                <img src="<?php echo $images ?>pages/3-convex.png" alt="Image description" height="40" width="40">
                                                <span class="font-small-2 d-block">Convex</span>
                                            </a>
                                        </div>
                                        <div class="suggestion-1 d-inline-block text-center mr-2">
                                            <a href="https://1.envato.market/materialize_admin" target="_blank">
                                                <img src="<?php echo $images ?>pages/4-materialize.png" alt="Image description" height="40" width="40">
                                        ...
                                        <div class="suggestion-1 d-inline-block text-center">
                                            <a href="https://1.envato.market/stack_admin" target="_blank">
                                                <img src="<?php echo $images ?>pages/2-stack.png" alt="Image description" height="40" width="40">
