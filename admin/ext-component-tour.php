...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $vendors ?>css/extensions/tether-theme-arrows.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $vendors ?>css/extensions/tether.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $vendors ?>css/extensions/shepherd-theme-default.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>plugins/tour/tour.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
   ...
   <?php
    ...
    <script src="<?php echo $vendors ?>js/extensions/tether.min.js"></script>
    <script src="<?php echo $vendors ?>js/extensions/shepherd.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="layout/js/scripts/extensions/tour.js"></script>
    <!-- END: Page JS-->
