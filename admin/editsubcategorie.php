...
$subcategorys = new subcategory();
 if(!isset($_GET['do'])){
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
		$subcategorys->update_subcategory($_POST["subid"],$_POST["catid"],$_POST["subname"]);
	
	  header("Location: sub_categorie.php");
      exit();
  }}
	?>
<!DOCTYPE html>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Edit Subcategorie</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="sub_categorie.php">Subcategorie</a>
                                    </li>
                                    <li class="breadcrumb-item active">Edit Subcategorie
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Subcategorie</h4>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Name</label>
                                                        <div class="controls">
															<input  name="subid" hidden value ="<?php echo  $_GET['subid']; ?>" type="text">
                                                            <input name="subname" value ="<?php echo  $_GET['subname']; ?>" type="text"  class="form-control" data-validation-required-message="This field is required" placeholder="Name">
                                                        </div>
                                                    </div>
