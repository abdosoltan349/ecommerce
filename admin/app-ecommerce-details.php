...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>pages/app-ecommerce-details.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns ecommerce-application navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
<?php
                            ...
                            <div class="row mb-5 mt-2">
                                <div class="col-12 col-md-5 d-flex align-items-center justify-content-center mb-2 mb-md-0">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="<?php echo $images ?>elements/macbook-pro.png" class="img-fluid" alt="product image">
                                    </div>
                                </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide rounded swiper-shadow">
                                        ...
                                        <div class="img-container w-50 mx-auto my-2 py-75">
                                            <img src="<?php echo $images ?>elements/apple-watch.png" class="img-fluid" alt="image">
                                        </div>
                                        <div class="item-meta">
                                    ...
                                    <div class="swiper-slide rounded swiper-shadow">
                                        ...
                                        <div class="img-container w-50 mx-auto my-2 py-75">
                                            <img src="<?php echo $images ?>elements/beats-headphones.png" class="img-fluid" alt="image">
                                        </div>
                                        <div class="item-meta">
                                            <div class="product-rating">
                                                <i class="feather icon-star text-warning"></i>
                                    ...
                                    <div class="swiper-slide rounded swiper-shadow">
                                        ...
                                        <div class="img-container w-50 mx-auto my-3 py-50">
                                            <img src="<?php echo $images ?>elements/macbook-pro.png" class="img-fluid" alt="image">
                                        </div>
                                        <div class="item-meta">
                                            <div class="product-rating">
                                                <i class="feather icon-star text-warning"></i>
                                    ...
                                    <div class="swiper-slide rounded swiper-shadow">
                                        ...
                                        <div class="img-container w-50 mx-auto my-2 py-75">
                                            <img src="<?php echo $images ?>elements/homepod.png" class="img-fluid" alt="image">
                                        </div>
                                        <div class="item-meta">
                                            <div class="product-rating">
                                                <i class="feather icon-star text-warning"></i>
                                    ...
                                    <div class="swiper-slide rounded swiper-shadow">
                                        ...
                                        <div class="img-container w-50 mx-auto my-2 py-75">
                                            <img src="<?php echo $images ?>elements/magic-mouse.png" class="img-fluid" alt="image">
                                        </div>
                                        <div class="item-meta">
                                            <div class="product-rating">
                                                <i class="feather icon-star text-warning"></i>
                                    ...
                                    <div class="swiper-slide rounded swiper-shadow">
                                        ...
                                        <div class="img-container w-50 mx-auto my-2 py-75">
                                            <img src="<?php echo $images ?>elements/iphone-x.png" class="img-fluid" alt="image">
                                        </div>
                                        <div class="item-meta">
                                            <div class="product-rating">
                                                <i class="feather icon-star text-warning"></i>
    ...
    <!-- BEGIN: Page JS-->
    <script src="layout/js/scripts/pages/app-ecommerce-details.js"></script>
