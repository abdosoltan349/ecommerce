...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $vendors ?>css/ui/prism.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>plugins/extensions/noui-slider.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>pages/app-ecommerce-shop.css">
    <!-- END: Page CSS-->
...
<?php
                ...
                <div class="content-body">
                    ...
                    <section id="ecommerce-products" class="grid-view">
                        <div class="card ecommerce-card">
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details">Amazon - Fire TV Stick with Alexa Voice Remote - Black</a>
                                ...
                                <div class="item-options text-center">
                                    ...
                                    <div class="cart">
                                        <i class="feather icon-shopping-cart"></i> <span class="add-to-cart">Add to cart</span> <a href="app-ecommerce-checkout" class="view-in-cart d-none">View In Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card ecommerce-card">
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details">Google - Chromecast - Black</a>
                                ...
                                <div class="item-options text-center">
                                    ...
                                    <div class="cart">
                                        <i class="feather icon-shopping-cart mr-25"></i> <span class="add-to-cart">Add to cart</span> <a href="app-ecommerce-checkout" class="view-in-cart d-none">View In Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card ecommerce-card">
                            <div class="card-content">
                                <div class="item-img text-center">
                                    <a href="app-ecommerce-details"><img class="img-fluid" src="<?php echo $images ?>pages/eCommerce/3.png" alt="img-placeholder"></a>
                                </div>
                                <div class="card-body">
                                    <div class="item-wrapper">
                                        <div class="item-rating">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details">Dell - Inspiron 15.6" Touch-Screen Laptop - Black</a>
                        ...
                        <div class="card ecommerce-card">
                            <div class="card-content">
                                <div class="item-img text-center">
                                    <a href="app-ecommerce-details"> <img class="img-fluid" src="<?php echo $images ?>pages/eCommerce/4.png" alt="img-placeholder"></a>
                                </div>
                                <div class="card-body">
                                    <div class="item-wrapper">
                                        <div class="item-rating">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details">Amazon - Echo Dot</a>
                                        <p class="item-company">By <span class="company-name">Amazon</span></p>
                                    </div>
                                    <div>
                                        <p class="item-description">
    ...
    <script src="<?php echo $vendors ?>js/ui/prism.min.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="layout/js/scripts/pages/app-ecommerce-shop.js"></script>
    <!-- END: Page JS-->
