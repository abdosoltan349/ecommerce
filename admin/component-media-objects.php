                                        ...
                                        <div class="media-list">
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-3.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-6.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-1.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-heading">Tootsie roll dessert </h4>
                                                    Tootsie roll dessert tart candy canes ice cream gingerbread cookie. Jelly jelly-o bear claw bear claw
                                        ...
                                        <div class="media-list">
                                            <div class="media">
                                                ...
                                                <a class="media-right" href="#">
                                                    <img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-10.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            </div>
                                            <div class="media">
                                                <div class="media-body text-right">
                                                ...
                                                <a class="media-right" href="#">
                                                    <img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-7.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            </div>
                                            <div class="media">
                                                <div class="media-body text-right">
                                                ...
                                                <a class="media-right" href="#">
                                                    <img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-2.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="media-list media-bordered">
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-23.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-heading">Cookie candy</h4>
                                                    Cookie candy dragée marzipan gingerbread pie pudding. Brownie fruitcake wafer bonbon gummi bears apple
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-16.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-heading">Tootsie roll dessert </h4>
                                                    Tootsie roll dessert tart candy canes ice cream gingerbread cookie. Jelly jelly-o bear claw bear claw
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-15.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media-list media-bordered">
                                            <div class="media">
                                                ...
                                                <a class="media-right" href="#">
                                                    <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-9.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            </div>
                                            <div class="media">
                                                <div class="media-body text-right">
                                                ...
                                                <a class="media-right" href="#">
                                                    <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-14.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            </div>
                                            <div class="media">
                                                <div class="media-body text-right">
                                                ...
                                                <a class="media-right" href="#">
                                                    <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-21.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            <img src="<?php echo $images ?>portrait/small/avatar-s-12.jpg" class="mr-1" alt="img placeholder" height="64" width="64">
                                            <div class="media-body">
                                                ...
                                                <div class="media mt-3">
                                                    <a class="mr-1" href="#">
                                                        <img src="<?php echo $images ?>portrait/small/avatar-s-13.jpg" alt="img placeholder" height="64" width="64">
                                                    </a>
                                                    <div class="media-body">
                                                        <h5 class="mt-0">Media heading</h5>
                                        ...
                                        <div class="media-list media-bordered">
                                            <div class="media">
                                                <a class="align-self-start media-left" href="#">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-4.jpg" alt="Generic placeholder image" height="64" width="64" />
                                                </a>
                                                <div class="media-body">
