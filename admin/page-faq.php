...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>pages/faq.css">
    <!-- END: Page CSS-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="supporter-details mt-2">
                                        <div class="supporter-img d-inline-block">
                                            <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-1.jpg" alt="Avatar">
                                        </div>
                                    ...
                                    <div class="supporter-details mt-2">
                                        <div class="supporter-img d-inline-block">
                                            <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-2.jpg" alt="Avatar">
                                        </div>
                                        <div class="supporter-info d-inline-block">
                                    ...
                                    <div class="supporter-details mt-2">
                                        <div class="supporter-img d-inline-block">
                                            <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-3.jpg" alt="Avatar">
                                        </div>
                                        <div class="supporter-info d-inline-block">
                                    ...
                                    <div class="supporter-details mt-2">
                                        <div class="supporter-img d-inline-block">
                                            <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-4.jpg" alt="Avatar">
                                        </div>
                                        <div class="supporter-info d-inline-block">
                                    ...
                                    <div class="supporter-details mt-2">
                                        <div class="supporter-img d-inline-block">
                                            <img class="rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-5.jpg" alt="Avatar">
                                        </div>
                                        <div class="supporter-info d-inline-block">
