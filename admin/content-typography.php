...
<head>
    ...
    <title>Typography - Vuexy - Bootstrap HTML admin template</title>
                        ...
                        <div class="card-body">
                            <div class="card-text">
                                <p>The default web fonts (Helvetica Neue, Helvetica, and Arial) have been dropped in Bootstrap 4 and replaced
                                    with a “native font stack” for optimum text rendering on every device and OS. Read more about <a href="https://getbootstrap.com/docs/4.3/content/reboot/#native-font-stack" target="_blank">native font stacks</a></p>
                                <ul>
                                    <li>Use a <a href="https://getbootstrap.com/docs/4.3/content/reboot/#native-font-stack">native font stack</a> that selects the best <code class="highlighter-rouge">font-family</code> for each OS and device.</li>
                                    ...
                                    <li>Use <code class="highlighter-rouge">$body-bg</code> to set a <code class="highlighter-rouge">background-color</code> on the <code class="highlighter-rouge">&lt;body&gt;</code> (<code class="highlighter-rouge">#fff</code> by default).
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="card-text">
                                        ...
                                        <blockquote class="blockquote pl-1 border-left-primary border-left-3">
                                            <div class="media">
                                                <div class="media-left pr-1">
                                                    <img class="media-object img-xl" src="<?php echo $images ?>portrait/small/avatar-s-5.jpg" alt="Generic placeholder image">
                                                </div>
                                        ...
                                        <blockquote class="blockquote mt-1">
                                            <div class="media">
                                                <div class="media-left pr-1">
                                                    <img class="media-object img-xl rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-3.jpg" alt="Generic placeholder image">
                                                </div>
                                                <div class="media-body">
                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                </div>
