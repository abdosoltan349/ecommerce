...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0 w-100">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center p-0">
                                    <img src="<?php echo $images ?>pages/reset-password.png" alt="branding logo">
                                </div>
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row pt-2">
                                                        <div class="col-12 col-md-6 mb-1">
                                                            <a href="auth-login.php" class="btn btn-outline-primary btn-block px-0">Go Back to Login</a>
                                                        </div>
                                                        <div class="col-12 col-md-6 mb-1">
