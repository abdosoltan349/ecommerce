<?php
 ...
 if(!isset($_GET['do'])){
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
	 ...
	 $taxs->updateTax($_POST["couponid"],$_POST["name"],$_POST["pe"]);
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="tax.php">Tax</a>
                                    </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" novalidate action = "<?php echo $_SERVER["PHP_SELF"]."?do=update" ?>" method = "post">
                                            <div class="row">
                                                <div class="col-md-12">
											        ...
											        <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input value ="<?php echo  $_GET['pe']; ?>"  name="pe" class="form-control" data-validation-required-message="Must be a valid price" placeholder="value">
                                                        </div>
                                                    </div>
