...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $css ?>pages/app-chat.css">
    <!-- END: Page CSS-->
...
<?php
                    ...
                    <div class="chat-profile-sidebar">
                        <header class="chat-profile-header">
                            ...
                            <div class="header-profile-sidebar">
                                <div class="avatar">
                                    <img src="<?php echo $images ?>portrait/small/avatar-s-11.jpg" alt="user_avatar" height="70" width="70">
                    ...
                    <div class="sidebar-content card">
                        ...
                        <div class="chat-fixed-search">
                            <div class="d-flex align-items-center">
                                <div class="sidebar-profile-toggle position-relative d-inline-flex">
                                    <div class="avatar">
                                        <img src="<?php echo $images ?>portrait/small/avatar-s-11.jpg" alt="user_avatar" height="40" width="40">
                        ...
                        <div id="users-list" class="chat-user-list list-group position-relative">
                            ...
                            <ul class="chat-users-list-wrapper media-list">
                                <li>
                                    <div class="pr-1">
                                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-3.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                    </div>
                                ...
                                <li>
                                    <div class="pr-1">
                                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-7.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="user-chat-info">
                            ...
                            <ul class="chat-users-list-wrapper media-list">
                                <li>
                                    <div class="pr-1">
                                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-8.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="user-chat-info">
                                ...
                                <li>
                                    <div class="pr-1">
                                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-5.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="user-chat-info">
                                ...
                                <li>
                                    <div class="pr-1">
                                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-9.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="user-chat-info">
                                ...
                                <li>
                                    <div class="pr-1">
                                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="<?php echo $images ?>portrait/small/avatar-s-14.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="user-chat-info">
                    ...
                    <div class="content-body">
                                    ...
                                    <header class="chat_header d-flex justify-content-between align-items-center p-1">
                                        <div class="vs-con-items d-flex align-items-center">
                                            ...
                                            <div class="avatar user-profile-toggle m-0 m-0 mr-1">
                                                <img src="<?php echo $images ?>portrait/small/avatar-s-1.jpg" alt="" height="40" width="40" />
                                    ...
                                    <div class="chats">
                                        <div class="chat">
                                            <div class="chat-avatar">
                                                <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-1.jpg" alt="avatar" height="40" width="40" />
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                    <img src="<?php echo $images ?>portrait/small/avatar-s-7.jpg" alt="avatar" height="40" width="40" />
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-content">
                                        ...
                                        <div class="chat">
                                            ...
                                            <div class="chat-body">
                                                ...
                                                <div class="chat-content">
                                                    <p>https://Error 404.ticksy.com/</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="user-profile-sidebar">
                            <header class="user-profile-header">
                                ...
                                <div class="header-profile-sidebar">
                                    <div class="avatar">
                                        <img src="<?php echo $images ?>portrait/small/avatar-s-1.jpg" alt="user_avatar" height="70" width="70">
    ...
    <!-- BEGIN: Page JS-->
    <script src="layout/js/scripts/pages/app-chat.js"></script>
    <!-- END: Page JS-->
