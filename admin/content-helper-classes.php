            ...
            &lt;/div&gt;
                ...
                &lt;h1 class="text-hide"&gt;Custom heading&lt;/h1&gt;
                                ...
                                <p>Use the <code class="highlighter-rouge">.text-hide</code> class to maintain the accessibility and SEO
                                    ...
                                    instead of text.</p>
                                <div class="bd-example">
                                    <h1 class="text-hide my-2" style="background-image: url('<?php echo $images ?>logo/logo.png'); width: 30px; height: 26px;">
                                        Bootstrap</h1>
                                </div>
                                <pre><code class="language-html">
                &lt;h1 class="text-hide my-2" style="background-image: url('<?php echo $images ?>logo/logo.png'); width: 30px; height: 26px;"&gt;Bootstrap&lt;/h1&gt;
                </code></pre>
                            </div>
                        </div>
                    </div>
