...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="admin/<?php echo $images ?>ico/favicon.ico">
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="admin/<?php echo $images ?>pages/404.png" class="img-fluid align-self-center" alt="branding logo">
